...
export const renderSummaryCards = (summaryData) => {
    ...
    const cards = [
      ...
      { title: 'PPG Duration per Participant', value: avgPPGDurationPerPatient, color: { 50: '#ede7f6', 700: '#673ab7', 800: '#311b92' } },
      { title: 'ECG Duration per Participant', value: avgECGDurationPerPatient, color: { 50: '#fff8e1', 700: '#f57c00', 800: '#e65100' } },
      { title: 'Accelerometry Duration per Participant', value: avgAccelerometryDurationPerPatient, color: { 50: '#e1f5fe', 700: '#0288d1', 800: '#01579b' } },
